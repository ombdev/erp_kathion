/*
 * Clase que contruye PDF para el Reporte Auxiliar de Cuentas
 * 
 */
...
public class CtbPdfReporteAuxiliarDeCuentas {
    ...
    public CtbPdfReporteAuxiliarDeCuentas(String fileout, HashMap<String, String> datosEncabezadoPie, HashMap<String, String> datosEmpresa, ArrayList<HashMap<String, String>> itemsForPrinting){
